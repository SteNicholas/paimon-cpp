...
TEST_F(TagTest, TestSimple) {
    ...
    const auto tag_create_time = std::chrono::duration_cast<std::chrono::microseconds>(
    ...
    const Tag tag(
        ...
        /*tag_create_time=*/tag_create_time, /*tag_time_retained=*/5000);
    ...
    ASSERT_EQ(5000, tag.TagTimeRetained().value());
}
...
TEST_F(TagTest, TestFromPath) {
    ...
    ASSERT_EQ(std::nullopt, tag.TagCreateTime());
    ASSERT_EQ(std::nullopt, tag.TagTimeRetained());
}
...
TEST_F(TagTest, TestJsonizable) {
    const std::string json_str = R"({
        ...
        "tagCreateTime": 1769503588,
        "tagTimeRetained": 1000
    })";
    ...
    const Tag expected_tag(
        ...
        /*next_row_id=*/std::nullopt, /*tag_create_time=*/1769503588, /*tag_time_retained=*/1000);
